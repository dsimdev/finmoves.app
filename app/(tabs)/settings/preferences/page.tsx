...
export default function PreferencesSettings() {
  ...
  return (
    <div className="page page-narrow">
      ...
      {/* El toggle de "Vibración" se sacó en v2.102.0: la Vibration API no existe en iOS, así
          que prometía algo que ahí nunca pasaba. El feedback visual va siempre y no se
          configura. */}
