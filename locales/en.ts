...
export const en: AppLocale = {
  ...
  obCurrencyBody: "Pick the currency you handle most of your money in. You can change it later in Account.",
  obPeriodTitle: "How does the period work?",
  obPeriodBody: "Your salary opens a period. Your expenses subtract from it. When something important happens (new salary, month changes), you open a new one and leftovers go to Savings.",
  obSavingsVsInvestTitle: "Savings vs Investment",
  obSavingsVsInvestBody: "Savings is your safety net. Investment is when you want to grow it: you buy dollars/euros with your savings and hope they go up in value.",
  obGainCalculationTitle: "How is the gain calculated?",
  obGainCalculationBody: "You buy at one price, sell at another. Sell higher = gain. Sell lower = loss. We show your total gain or loss at all times.",
  obReportsTitle: "What about reports?",
  obReportsBody: "Each period you see how much you spent, earned, and saved. Reports show you where your money goes and help you decide better.",
