...
export const en: AppLocale = {
  ...
  analyzeSearchPlaceholder: "Note, description…",
  analyzeEmpty: "Search a category or keyword to see its evolution.",
  ...
  analyzeAllCategories: "All categories",
  analyzeNCategories: (n: number) => `${n} categories`,
  analyzeTimes: (n: number) => `${n} ${n === 1 ? "time" : "times"}`,
  analyzeDays: (n: number) => `${n} ${n === 1 ? "day" : "days"}`,
  analyzeCategoriesTitle: "Categories",
  analyzeClear: "Clear",
  analyzeCategoryPlaceholder: "Filter by category…",
