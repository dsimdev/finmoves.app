export const es = {
  ...
  obCurrencyBody: "Elegí la moneda en la que controlás la mayor parte de tu plata. Podés cambiarla después en Cuenta.",
  obPeriodTitle: "¿Cómo funciona el período?",
  obPeriodBody: "Tu sueldo abre un período. Tus gastos lo descuentan. Cuando pase algo importante (nuevo sueldo, cambio de mes), abrís uno nuevo y lo que sobró pasa a Ahorros.",
  obSavingsVsInvestTitle: "Ahorros vs Inversión",
  obSavingsVsInvestBody: "Ahorros es tu colchón de dinero. Inversión es cuando querés multiplicarlo: comprás dólares/euros con tus ahorros y esperás que suban de valor.",
  obGainCalculationTitle: "¿Cómo se calcula la ganancia?",
  obGainCalculationBody: "Comprás a un precio, vendés a otro. Si vendés más caro, ganancia. Si vendés más barato, pérdida. Mostramos en todo momento cuánto ganaste o perdiste.",
  obReportsTitle: "¿Y los reportes?",
  obReportsBody: "Cada período ves cuánto gastaste, ganaste, ahorraste. Los reportes te muestran dónde va tu plata y te ayudan a decidir mejor.",
