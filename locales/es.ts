export const es = {
  ...
  analyzeSearchPlaceholder: "Observación, descripción…",
  analyzeEmpty: "Buscá una categoría o palabra clave para ver su evolución.",
  ...
  analyzeAllCategories: "Todas las categorías",
  analyzeNCategories: (n: number) => `${n} categorías`,
  analyzeTimes: (n: number) => `${n} ${n === 1 ? "vez" : "veces"}`,
  analyzeDays: (n: number) => `${n} ${n === 1 ? "día" : "días"}`,
  analyzeCategoriesTitle: "Categorías",
  analyzeClear: "Limpiar",
  analyzeCategoryPlaceholder: "Filtrar por categoría…",
