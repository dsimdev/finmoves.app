export const es = {
  ...
  obCurrencyBody: "Elegí la moneda en la que controlás la mayor parte de tu plata.",
  obCurrencyWarning: "La moneda que selecciones aquí quedará fija y no podrá ser cambiada después.",
