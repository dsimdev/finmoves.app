export const es = {
  ...
  filterTitle: "Filtrar",
  filterHint: "Escribí una palabra (categoría, descripción u observación) para filtrar los movimientos de este período.",
  ...
  inflation: "Gasto vs anterior",
  inflationNominal: "Gasto vs ant. (nominal)",
  inflationTitle: "Inflación nominal",
  inflationSub: "tu gasto, período a período",
  kpiInflationInfo: "Cuánto llevás gastado en este período comparado con todo el período anterior, ajustado por inflación (IPC) y sin contar compras de dólares. Al empezar el período va a dar negativo: todavía gastaste poco.",
  kpiInflationAvgInfo: "Promedio de cuánto cambió tu gasto entre períodos, sin contar compras de dólares.",
  kpiInflationInfoNominal: "Cuánto llevás gastado en este período comparado con todo el período anterior, sin contar compras de divisas. Al empezar el período va a dar negativo: todavía gastaste poco.",
