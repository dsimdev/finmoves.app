export const es = {
  ...
  kpiTypicalInfo: "Es la mediana entre tus períodos: el valor del medio. La mitad de los períodos queda por encima y la otra mitad por debajo. A diferencia del promedio, no se distorsiona por un período atípico.",
  avgSavings: "Ahorro típico",
  kpiTypicalSavingsInfo: "Mediana de lo que destinás a ahorros por período (depósitos + ingresos que van directo a ahorro). La mitad de los períodos queda por encima y la otra mitad por debajo.",
