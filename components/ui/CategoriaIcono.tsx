...
const TRAZOS: Record<CategoriaIconoId, React.ReactNode> = {
  ...
  regalos: <><rect x="3" y="8" width="18" height="13" rx="2" /><path d="M12 8v13M3 12h18" /></>,
  ...
  trabajo: <><rect x="2" y="7" width="20" height="14" rx="2" /><path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16" /></>,
  deporte: <><circle cx="12" cy="12" r="9" /><path d="M12 3a9 9 0 0 0 0 18M12 3a9 9 0 0 1 0 18M3.5 9h17M3.5 15h17" /></>,
  belleza: <><path d="M12 2v6M9 8h6l-1 13a2 2 0 0 1-4 0z" /><path d="M9.5 12h5" /></>,
