...
// Bottom-sheet genérico, con handle arrastrable: arrastrar hacia abajo achica el
// modal (peek, sin perder lo cargado) y hacia arriba lo restaura; bien abajo, cierra.
